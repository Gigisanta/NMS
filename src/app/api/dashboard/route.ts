...
export async function GET() {
  try {
    // BOLT OPTIMIZATION: Use cachedFetch to reduce database load for the dashboard
    // The dashboard is the most frequently accessed page and performs 8 parallel queries.
