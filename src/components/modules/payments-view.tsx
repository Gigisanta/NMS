...
// BOLT OPTIMIZATION: Extracted and memoized row component to prevent redundant re-renders
...
export function PaymentsView() {
  ...
  // BOLT OPTIMIZATION: Memoized status change handler
  const handleStatusChange = useCallback(async (subscriptionId: string, newStatus: string, paymentMethod?: string) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        // Invalidate dashboard cache in store to trigger refresh
  ...
  // BOLT OPTIMIZATION: Memoized payment click handler
