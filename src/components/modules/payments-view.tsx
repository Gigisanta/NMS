...
// BOLT OPTIMIZATION: Extract table row to a memoized component to prevent
// unnecessary re-renders of the entire list when only one item changes.
...
export function PaymentsView() {
  ...
  // BOLT OPTIMIZATION: Calculate stats in a single pass O(N) instead of multiple .filter() calls O(4N)
  const stats = useMemo(() => {
